...
BOX_WEIGHT = "D"
UNIT_MEASUREMENTS = "E"
WEIGHT_SKU = "F"  # если UNIT_MEASUREMENTS => кг, то WEIGHT_OF_SKU = 1 !!!
ORDER = "G"  # колонка куда заносим заказ
...
file_order = "новый_бланк/Единый Бланк заказа КИ Узбекистан (заказ на ).xlsx"
...
{sh_order[f"{NAME_SKU}{row}"].value}.\n"
                    ...
                    # если UNIT_MEASUREMENTS => кг, то WEIGHT_OF_SKU = 1 !!!
...
wb_order.save("Единый Бланк заказа КИ Узбекистан (заказ на ).xlsx")
