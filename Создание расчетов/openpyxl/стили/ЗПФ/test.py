...
width_cols = {'Ед. изм.': 3, 'Начальный остаток': 6, 'Приход': 6, 'Расход': 7, 'Конечный остаток': 7, 'крат': 5, 'сроки': 5,
             'метка': 9, 'метка2': 1, 'заяв': 6.5, 'разн': 5.5, 'без опта': 6, 'опт': 6, 'заказ в пути': 6, 'ср нов': 6, 'расчет (потребность)': 7,
             'расчет (отгрузит завод)': 7, 'заказ филиала': 7, 'Комментарии филиала': 15, 'кон ост': 5, 'факт': 5, 'ср': 6, 'комментарии': 20, 
             'вес': 6, 'крат кор': 6, 'заказ кор.': 7, 'ВЕС': 6, 'ряд': 5, 'паллет': 5, 'кол-во паллет': 6}
